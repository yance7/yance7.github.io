...
export const zhHKMessages = {
  ...
  compass: { label: '頁面章節羅盤', open: '展開章節導覽', close: '收起章節導覽', progress: '頁面閱讀進度', returnTop: '返回頂部', current: '目前', previous: '上一章節', next: '下一章節', goToSection: '前往章節', read: '閱讀' },
  accessibility: { skipToMain: '跳到主要內容', home: '返回首頁', footerHome: '返回個人檔案首頁', liveProduct: '開啟產品網站', projectStory: '項目故事' },
  common: { online: '在線', current: '目前', previous: '上一張', next: '下一張', readPaper: '閱讀論文', openProject: '開啟項目', proof: '證據', source: '原始碼', deployedAs: '上線為', liveProduct: '在線產品' },
  ...
  home: { identity: '研究者 / 建構者 / 音樂聽眾', selectedWorkLabel: '精選作品', productLabel: '產品', researchToProduct: '研究 → 產品', exploreLabel: '探索', worldsDescription: '把探索、榮譽、研究、作品與音樂分別收進五間屋子。', beyondLabel: '實驗室之外', leadership: '領導力', selectedActivities: '精選活動' },
  ...
  footer: { profile: '個人檔案', researchRepos: '研究倉庫', contact: '聯絡' },
