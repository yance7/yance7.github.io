...
export const zhHKMessages = {
  ...
  actions: { selectedWork: '查看精選作品', exploreWorlds: '瀏覽五個小世界', scrollToExplore: '向下探索', readResearch: '閱讀研究', viewCaseStudy: '查看產品案例', exploreAcademics: '探索學業', viewHonors: '查看榮譽', enterProject: '進入項目', viewOnGitHub: '在 GitHub 查看', sourceCode: '原始碼', openResearch: '開啟研究' },
  ...
  footer: { homeLabel: '返回首頁', contactsLabel: '聯絡方式', archive: '個人檔案 / 2026', identity: '研究者 / 建構者 / 音樂聽眾', email: '電郵', github: 'GitHub' },
