...
export const zhCNMessages = {
  ...
  accessibility: { skipToMain: '跳到主要内容', readingProgress: '阅读进度', home: '返回首页', footerHome: '返回个人档案首页', liveProduct: '打开产品网站', projectStory: '项目故事' },
  ...
  actions: { selectedWork: '查看精选作品', exploreWorlds: '浏览五个小世界', scrollToExplore: '滚动探索', readResearch: '阅读研究', viewCaseStudy: '查看产品案例', exploreAcademics: '探索学业', viewHonors: '查看荣誉', enterProject: '进入项目', viewOnGitHub: '在 GitHub 查看', sourceCode: '源码', openResearch: '打开研究' },
  ...
  footer: { homeLabel: '返回首页', contactsLabel: '联系方式', archive: '个人档案 / 2026', identity: '研究者 / 构建者 / 音乐听众', email: '邮箱', github: 'GitHub' },
