...
export const zhCNMessages = {
  ...
  compass: { label: '页面章节罗盘', open: '展开章节导航', close: '收起章节导航', progress: '页面阅读进度', returnTop: '回到顶部', current: '当前', previous: '上一章节', next: '下一章节', goToSection: '前往章节', read: '阅读' },
  accessibility: { skipToMain: '跳到主要内容', home: '返回首页', footerHome: '返回个人档案首页', liveProduct: '打开产品网站', projectStory: '项目故事' },
  common: { online: '在线', current: '当前', previous: '上一张', next: '下一张', readPaper: '阅读论文', openProject: '打开项目', proof: '证据', source: '源码', deployedAs: '上线为', liveProduct: '在线产品' },
  ...
  home: { identity: '研究者 / 构建者 / 音乐听众', selectedWorkLabel: '精选作品', productLabel: '产品', researchToProduct: '研究 → 产品', exploreLabel: '探索', worldsDescription: '把探索、荣誉、研究、作品与音乐分别收进五间屋子。', beyondLabel: '实验室之外', leadership: '领导力', selectedActivities: '精选活动' },
  ...
  footer: { profile: '个人档案', researchRepos: '研究仓库', contact: '联系' },
