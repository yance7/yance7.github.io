...
export const enMessages = {
  ...
  compass: { label: 'Page section navigator', open: 'Expand section navigation', close: 'Collapse section navigation', progress: 'Reading progress', returnTop: 'Back to top', current: 'Current', goToSection: 'Go to section', read: 'Read' },
