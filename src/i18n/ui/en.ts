...
export const enMessages = {
  ...
  compass: { label: 'Page section navigator', open: 'Expand section navigation', close: 'Collapse section navigation', progress: 'Reading progress', returnTop: 'Back to top', current: 'Current', previous: 'Previous section', next: 'Next section', goToSection: 'Go to section', read: 'Read' },
  accessibility: { skipToMain: 'Skip to main content', home: 'Return home', footerHome: 'Return to the personal archive home', liveProduct: 'Open live product', projectStory: 'Project story' },
  common: { online: 'Online', current: 'Current', previous: 'Previous image', next: 'Next image', readPaper: 'Read paper', openProject: 'Open project', proof: 'Evidence', source: 'Source', deployedAs: 'Deployed as', liveProduct: 'Live product' },
  ...
  home: { identity: 'Researcher / Builder / Music Listener', selectedWorkLabel: 'Selected work', productLabel: 'Product', researchToProduct: 'Research → Product', exploreLabel: 'Explore', worldsDescription: 'Five rooms for academics, honors, research, works, and music.', beyondLabel: 'Beyond the lab', leadership: 'Leadership', selectedActivities: 'Selected activities' },
  ...
  lightbox: { gallery: 'Concert poster gallery', close: 'Close lightbox', previous: 'Previous image', next: 'Next image', loading: 'Loading image', failed: 'Image failed to load', retry: 'Retry', posterAlt: 'poster', openArchive: 'Open archive' },
  ...
  footer: { profile: 'Personal profile', researchRepos: 'Research repositories', contact: 'Contact' },
