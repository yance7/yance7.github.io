...
export const pageMeta = {
  home: { kicker: 'PERSONAL ARCHIVE / 2026', title: '还记得你说家是唯一的城堡', copy: '研究、作品与被音乐点亮的夜晚，构成一个仍在生长的个人档案。', credit: { artist: '周杰伦', song: '稻香', album: '魔杰座' } },
  ...
  works: { kicker: 'WORKS / 作品', title: '因为我已明白，努力就能成功', copy: '两个已经上线的小世界，记录想法如何离开纸面，开始被真实使用。', credit: { artist: '汪苏泷', song: '慢慢懂', album: '慢慢懂' } },
