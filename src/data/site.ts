...
export const pageMeta = {
  ...
  works: { kicker: 'WORKS / 作品', title: '因为我已慢慢懂，努力就能成功', copy: '一个已经上线的小世界，记录想法如何离开纸面，开始被真实使用。', credit: { artist: '汪苏泷', song: '慢慢懂', album: '慢慢懂' } },
...
const worldsCopy = [
  ...
  { key: 'works', no: '04', label: '作品', en: 'Works', icon: '♬', desc: `${projects.length} 个已经上线的小世界，记录想法如何离开纸面，开始被真实使用。`, accent: 'aqua' },
