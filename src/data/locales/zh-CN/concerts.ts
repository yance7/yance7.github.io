...
export const concertsCopy = {
  ...
  currentYearMood: (attended, upcoming) => `${attended} 场已赴约，${upcoming} 场待相见。`,
  section: { label: 'LIVE ARCHIVE', title: '现场是', accent: '另一种记忆', copy: '点击海报进入全屏档案。每张图都保留原始比例。', nextUp: 'NEXT UP', realTime: '现实时间', archive: '演唱会档案', posterArchive: '打开档案', attended: '已赴约', upcoming: '待相见', venues: '场馆', artists: '艺人', posters: '张海报', total: '总现场', recorded: '已记录的演出', showUnit: '场' }
