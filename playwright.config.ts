...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      ...
      testMatch: /(?:site|locale|scroll-progress|footer|ui-primitives|english-layout|adaptive-header|works-showcase|concert-archive-rail|research-layout|motion-system|album-wall|home-hero-layout|home-hero-interaction)\.spec\.ts/
    },
    {
      name: 'webkit-mobile',
    ...
    { name: 'firefox-desktop-smoke', use: { ...devices['Desktop Firefox'] }, testMatch: /(?:compatibility|home-hero-layout|home-hero-interaction)\.spec\.ts/ },
    { name: 'chromium-android-smoke', use: { ...devices['Pixel 5'] }, testMatch: /(?:compatibility|home-hero-interaction)\.spec\.ts/ }
  ],
  webServer: {
