...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      ...
      testMatch: /(?:site|locale|scroll-progress|footer|ui-primitives|english-layout|adaptive-header|works-showcase|concert-archive-rail|research-layout|motion-system)\.spec\.ts/
    },
    {
      name: 'webkit-mobile',
