...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      ...
      testMatch: /(?:site|locale|page-compass-desktop|ui-primitives|english-layout|adaptive-header|works-showcase|concert-archive-rail|research-layout)\.spec\.ts/
    },
    {
      name: 'webkit-mobile',
      use: { ...devices['iPhone 13'], browserName: 'webkit' },
      testMatch: /(?:site|locale|page-compass-mobile|ui-primitives|english-layout|adaptive-header|works-showcase|concert-archive-rail|research-layout)\.spec\.ts/
    },
