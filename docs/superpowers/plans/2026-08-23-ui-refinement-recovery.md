...
- [x] Refresh `origin` with `git fetch origin --prune` on 2026-08-24. The working tree is clean; `HEAD` is `0aba048387d124de23aa0beda04d8f1a603ad038`, `origin/main` and `main` are `b0363e09252d909bab18956737190aa68e1b182c`, and `git rev-list --left-right --count origin/main...HEAD` is `0 12`. The active branch is `fix/ui-refinement-recovery`, already based on the current `main`; no development was performed directly on `main`.
...
- [x] Final local browser evidence: Chromium 96/96; Chromium visual 13/13; WebKit site 28 passed/1 skipped; Firefox 12 passed/3 skipped; Android 14 passed/1 skipped. The earlier full WebKit run was interrupted by a runner stall, so the report uses the dedicated WebKit site result rather than claiming that interrupted matrix. Committed the follow-up motion and theme-race fixes as `1745fa1` and `f320264`.
