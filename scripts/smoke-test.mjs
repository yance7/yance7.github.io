...
const honorsSource = readFileSync(join(root, 'src/pages/HonorsPage.vue'), 'utf8')
...
assert(concertsSource.includes('name="poster-fade"'), 'Concert poster transition missing')
assert(honorsSource.includes('name="honor-list"'), 'Honors filter transition missing')
...
assert(!/wave|sweep|background-video/i.test(styles), 'Legacy wave, sweep, or background video effects remain')
